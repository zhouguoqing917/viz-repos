...
import { find, map, some, toArray } from '@phosphor/algorithm';
import { BoxLayout, BoxPanel, DockPanel, Panel, SplitPanel, TabBar, Title, Widget } from '@phosphor/widgets';
import { Signal } from '@phosphor/signaling';
import { MimeData } from '@phosphor/coreutils';
import { Drag } from '@phosphor/dragdrop';
import { AttachedProperty } from '@phosphor/properties';
import { SHELL_TABBAR_CONTEXT_MENU, SideTabBar, TabBarRenderer, TabBarRendererFactory } from './tab-bars';
...
export class SidePanelHandler {
    ...
    protected onTabDetachRequested(sender: SideTabBar,
        ...
        clonedTab.style.width = null as any;
        clonedTab.style.height = null as any;
        const label = clonedTab.getElementsByClassName('p-TabBar-tabLabel')[0] as HTMLElement;
        label.style.width = null as any;
        label.style.height = null as any;
